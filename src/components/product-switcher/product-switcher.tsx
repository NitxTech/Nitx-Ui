...
export const ProductSwitcher = ({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-80 p-4 rounded-2xl dark:bg-black dark:border-zinc-600">
        {/* Profile Section */}
        <a
          ...
          href={profile.url}
          target="_blank"
          className="flex items-center w-full p-3 gap-2 rounded-xl border dark:border-zinc-700 mb-4 hover:bg-zinc-50 dark:hover:bg-zinc-900/70 dark:hover:text-white transition"
        >
        ...
        <div className="grid grid-cols-2 gap-3 mb-4 ltr dark:border-zinc-600" dir="ltr">
